...
public class VectorInvalidQueryTest extends SAITester
{
    ...
    public void disallowZeroVectorsWithCosineSimilarity() throws Throwable
    {
        ...
        assertThatThrownBy(() -> execute("INSERT INTO %s (pk, value) VALUES (0, ?)", floatVector(0, 0))).isInstanceOf(InvalidRequestException.class);
        assertThatThrownBy(() -> execute("INSERT INTO %s (pk, value) VALUES (0, ?)", floatVector(1, Float.NaN))).isInstanceOf(InvalidRequestException.class);
        assertThatThrownBy(() -> execute("INSERT INTO %s (pk, value) VALUES (0, ?)", floatVector(1, Float.POSITIVE_INFINITY))).isInstanceOf(InvalidRequestException.class);
        assertThatThrownBy(() -> execute("INSERT INTO %s (pk, value) VALUES (0, ?)", floatVector(Float.NEGATIVE_INFINITY, 1))).isInstanceOf(InvalidRequestException.class);
