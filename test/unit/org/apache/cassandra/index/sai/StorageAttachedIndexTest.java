...
import static org.apache.cassandra.cql3.CQLTester.floatVector;
...
public class StorageAttachedIndexTest
{
    ...
    public void setup() throws Throwable
    {
        ...
        CQLTester.Vector<Float> vector1 = floatVector(1f, 2f);
        CQLTester.Vector<Float> vector2 = floatVector(3f, 4f);
        CQLTester.Vector<Float> vector3 = floatVector(5f, 6f);
