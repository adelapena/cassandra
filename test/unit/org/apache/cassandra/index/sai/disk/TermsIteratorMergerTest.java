...
public class TermsIteratorMergerTest extends SAITester
{
    ...
    {
        List<TermsIterator> iterators = new ArrayList<>();
        ...
        for (int termIteratorCount = 0; termIteratorCount < getRandom().nextIntBetween(2, 50); termIteratorCount++)
        {
            ...
            for (int termCount = 0; termCount < getRandom().nextIntBetween(2, expected.size() - 1); termCount++)
            {
                ...
                iterators.add(new TermsIteratorImpl(termMap));
            }
        }
    ...
    public static class TermsIteratorImpl implements TermsIterator
    {
        ...
        {
            iterator = ImmutableSet.copyOf(map.entrySet()).iterator();
        }
        ...
        public PostingList postings()
        {
            ...
            {
                int index = 0;
                final Long[] postings = current.getValue();
