...
public class OffsetFactoryTest
{
    ...
    public void testTokenSkippingCacheWidePartition() throws IOException
    {
        ...
        try (OffsetFactory.TokenLongArray offsetLongArray = new OffsetFactory.TokenLongArray(mock(SSTableQueryContext.class), token, 0))
        {
    ...
    @Test
    public void testTokenSkippingOnLargeSSTable() throws IOException
    {
        LongArray tokens = mock(LongArray.class);
        ...
        try (OffsetFactory.TokenLongArray offsetLongArray = new OffsetFactory.TokenLongArray(context, tokens, segmentRowIdOffset))
        {
