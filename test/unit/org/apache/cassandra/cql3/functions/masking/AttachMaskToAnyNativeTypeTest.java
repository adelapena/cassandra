...
/**
 * {@link AttachMaskTester} verifying that we can attach column masks to table columns of any native data type.
 */
@RunWith(Parameterized.class)
public class AttachMaskToAnyNativeTypeTest extends AttachMaskTester
{
