...
/**
 * {@link AttachMaskTester} verifying that masks can be applied to columns in any position (partition key columns,
 * clustering key columns, static columns and regular columns), including materialized views.
 */

@RunWith(Parameterized.class)
public class AttachMaskToColumnsInAnyPositionTest extends AttachMaskTester
{
