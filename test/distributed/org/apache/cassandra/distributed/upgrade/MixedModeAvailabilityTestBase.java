...
public abstract class MixedModeAvailabilityTestBase extends UpgradeTestBase
{
    ...
    protected abstract Semver from();
    ...
    private void testAvailability(boolean upgradedCoordinator) throws Throwable
    {
        ...
        .withConfig(config -> config.with(GOSSIP, NETWORK, NATIVE_PROTOCOL)
                                    .set("request_timeout_in_ms", MINUTES.toMillis(5))
                                    .set("read_request_timeout_in_ms", MINUTES.toMillis(5))
                                    .set("write_request_timeout_in_ms", MINUTES.toMillis(5)))
        .setup(cluster -> {
