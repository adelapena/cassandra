...
public abstract class CompactStoragePagingWithProtocolTester extends UpgradeTestBase
{
     ...
     */
    protected abstract Semver initial();

    /**
     * The final version we are upgrading to.
     */
    protected abstract Semver upgrade();
    ...
    private void assertRowsWithAllProtocolVersions(Object[]... rows)
    {
        ...
        if (initial().isGreaterThanOrEqualTo(v3X) && upgrade().isGreaterThanOrEqualTo(v3X))
