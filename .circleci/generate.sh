...
print_help()
{
  ...
  echo "                   -e REPEATED_UTESTS"
  echo "                   -e REPEATED_UTESTS_COUNT"
  echo "                   -e REPEATED_UTESTS_FQLTOOL"
  echo "                   -e REPEATED_UTESTS_FQLTOOL_COUNT"
  echo "                   -e REPEATED_UTESTS_LONG"
  echo "                   -e REPEATED_UTESTS_LONG_COUNT"
  echo "                   -e REPEATED_UTESTS_STRESS"
  echo "                   -e REPEATED_UTESTS_STRESS_COUNT"
  echo "                   -e REPEATED_JVM_DTESTS"
  echo "                   -e REPEATED_JVM_DTESTS_COUNT"
  echo "                   -e REPEATED_JVM_UPGRADE_DTESTS"
...
if $has_env_vars && $check_env_vars; then
  for entry in $(echo $env_vars | tr "|" "\n"); do
    ...
    if [ "$key" != "DTEST_REPO" ] &&
       ...
       [ "$key" != "REPEATED_JVM_UPGRADE_DTESTS_COUNT" ]; then
