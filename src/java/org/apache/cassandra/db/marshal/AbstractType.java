...
public abstract class AbstractType<T> implements Comparator<ByteBuffer>, AssignmentTestable
{
                                  ...
                                  boolean isForOfflineTool)
    {
        ...
        {
            if (isMultiCell())
                throw columnException(columnName, "non-frozen %s are not supported for PRIMARY KEY columns", category());
            ...
            if (referencesDuration())
                throw columnException(columnName, "duration types are not supported within PRIMARY KEY columns");

            if (comparisonType == ComparisonType.NOT_COMPARABLE)
                throw columnException(columnName,
                                      "type %s is not comparable and cannot be used for PRIMARY KEY columns",
    ...
    private InvalidColumnTypeException columnException(ByteBuffer columnName, String reason, Object... args)
    {
