...
CREATE INDEX not_analyzed_idx ON t(v) USING 'sai';
CREATE INDEX analyzed_idx ON t(v) USING 'sai' WITH OPTIONS = { 'index_analyzer': 'standard' };
...
CREATE INDEX idx ON t(v) USING 'sai' WITH OPTIONS = { 'index_analyzer': 'standard' };
