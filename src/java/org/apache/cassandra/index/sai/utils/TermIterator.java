...
public class TermIterator extends KeyRangeIterator
{
                                     ...
                                     QueryContext queryContext)
    {
        ...
        KeyRangeIterator memtableIterator = e.context.searchMemtableIndexes(e, keyRange);
        ...
        for (final SSTableIndex index : perSSTableIndexes)
        {
            try
            {
                ...
                List<KeyRangeIterator> keyIterators = index.search(e, keyRange, context);
            ...
            {
                if (logger.isDebugEnabled() && !(e1 instanceof QueryCancelledException))
        ...
        KeyRangeIterator ranges = KeyRangeUnionIterator.build(tokens);
