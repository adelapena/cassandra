...
public interface SegmentMerger extends Closeable
{
    ...
    SegmentMetadata merge(IndexDescriptor indexDescriptor,
                          ...
                          PrimaryKey minKey,
                          PrimaryKey maxKey) throws IOException;

    @SuppressWarnings({"resource", "RedundantSuppression"})
    static SegmentMerger newSegmentMerger()
    {
        return new LiteralSegmentMerger();
    }
    ...
    class LiteralSegmentMerger implements SegmentMerger
    {
        ...
        public SegmentMetadata merge(IndexDescriptor indexDescriptor,
                                     ...
                                     PrimaryKey maxKey) throws IOException
        {
            try (final TermsIteratorMerger merger = new TermsIteratorMerger(segmentTermsIterators, indexContext.getValidator()))
            {
