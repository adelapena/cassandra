...
public abstract class TimeFcts
{
    ...
    {
        public MinTimeuuidFunction(boolean leegacy)
        {
            super(leegacy ? "min_timeuuid" : "mintimeuuid", TimeUUIDType.instance, TimestampType.instance);
        }
    ...
    {
        public MaxTimeuuidFunction(boolean leegacy)
        {
            super(leegacy ? "max_timeuuid" : "maxtimeuuid", TimeUUIDType.instance, TimestampType.instance);
        }
    ...
    private static class ToDateFunction extends NativeScalarFunction
    {
        ...
        {
            super(useLegacyName ? "to_date" : "todate", SimpleDateType.instance, type);
            this.type = type;
        }
    ...
    private static class ToTimestampFunction extends NativeScalarFunction
    {
        ...
        {
            super(useLegacyName ? "to_timestamp" : "totimestamp", TimestampType.instance, type);
            this.type = type;
        }
    ...
    private static class ToUnixTimestampFunction extends NativeScalarFunction
    {
        ...
        {
            super(useLegacyName ? "to_unix_timestamp" : "tounixtimestamp", LongType.instance, type);
            this.type = type;
        }
